training_params = {
    ...
    "batch": 64,
    "seed": 0,
    "task": "scrambleddetect",
    "imgsz": 640,
    
    "prefix": "scrambleddetect_ablation",
}
...
models = {
    'YOLOv12n_4x4': {
        "cfg": "privacy/yolov12-scr_4x4_out3.yaml",
        "weights": "yolov12n_pretrained_on_baseline.pt",
        "override": {
            "scr_block_size": 4,
            "scr_num_blocks": 4,
            "scr_unique_blocks": False,
    ...
    'YOLOv12n_4x4_unique': {
        "cfg": "privacy/yolov12-scr_4x4_out3_unique.yaml",
        "weights": "yolov12n_pretrained_on_baseline.pt",
        "override": {
            "scr_block_size": 4,
            "scr_num_blocks": 4,
    ...
    'YOLOv12n_4x8': {
        "cfg": "privacy/yolov12-scr_4x8_out3.yaml",
        "weights": "yolov12n_pretrained_on_baseline.pt",
        "override": {
            "scr_block_size": 4,
            "scr_num_blocks": 8,
    ...
    'YOLOv12n_4x8_unique': {
        "cfg": "privacy/yolov12-scr_4x8_out3_unique.yaml",
        "weights": "yolov12n_pretrained_on_baseline.pt",
        "override": {
            "scr_block_size": 4,
            "scr_num_blocks": 8,
    ...
    'YOLOv12n_8x4': {
        "cfg": "privacy/yolov12-scr_8x4_out3.yaml",
        "weights": "yolov12n_pretrained_on_baseline.pt",
        "override": {
            "scr_block_size": 8,
            "scr_num_blocks": 4,
    ...
    'YOLOv12n_8x4_unique': {
        "cfg": "privacy/yolov12-scr_8x4_out3_unique.yaml",
        "weights": "yolov12n_pretrained_on_baseline.pt",
        "override": {
            "scr_block_size": 8,
            "scr_num_blocks": 4,
    ...
    'YOLOv12n_8x8': {
        "cfg": "privacy/yolov12-scr_8x8_out3.yaml",
        "weights": "yolov12n_pretrained_on_baseline.pt",
        "override": {
            "scr_block_size": 8,
            "scr_num_blocks": 8,
    ...
    'YOLOv12n_8x8_unique': {
        "cfg": "privacy/yolov12-scr_8x8_out3_unique.yaml",
        "weights": "yolov12n_pretrained_on_baseline.pt",
        "override": {
            "scr_block_size": 8,
            "scr_num_blocks": 8,
