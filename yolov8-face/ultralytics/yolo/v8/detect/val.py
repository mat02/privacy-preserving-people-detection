...
class ScrambledDetectionValidator(DetectionValidator):
    def __init__(self, dataloader=None, save_dir=None, pbar=None, args=None, _callbacks=None):
        super().__init__(dataloader=dataloader, save_dir=save_dir, pbar=pbar, args=args, _callbacks=_callbacks)
        
        self.args.rect = False if self.args.get("scr_enabled", False) else self.args.rect # override rect to fix problems with scrambler padding
